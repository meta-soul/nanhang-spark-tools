...
object QarNullSupplementDemo {
  ...
  private def dealPH5HZ(spark: SparkSession, partitionList: util.ArrayList[Row]): Unit = {
    ...
    spark.sql("create table qara_mid.mid_qara_320020_p5hz_fillup (`file_no` VARCHAR(2147483647), `flt_dt` VARCHAR(2147483647), `tail_num` VARCHAR(2147483647), `time` INT, `time_series` INT, `aie1_rw` INT, `aie2_rw` INT, `aiwl` INT, `aiwr` INT, `ai_faul1` INT, `ai_faul2` INT, `flaprw` FLOAT, `glide_dev1` FLOAT, `glide_dev2` FLOAT, `hyd_l_pres_b` INT, `hyd_l_pres_g` INT, `hyd_l_pres_y` INT, `loc_dev1` FLOAT, `loc_dev2` FLOAT, `n1_epr_cmd1` INT, `n1_epr_cmd2` INT, `n1_mod_sel1` INT, `n1_mod_sel2` INT, `pck_1_fl_ctl` INT, `pck_2_fl_ctl` INT, `ralt1` FLOAT, `ralt2` FLOAT, `tat` FLOAT) PARTITIONED BY (`flt_dt`, `tail_num`, `file_no`) with('path'='hdfs://10.64.219.26:9000/flink/warehouse/qara_mid/mid_qara_320020_p5hz_fillup', 'connector' = 'lakesoul','last_schema_change_time' = '1730889294312');")
    partitionList
      .forEach(partition => {
  ...
  private def dealP25hzTableData(spark: SparkSession, partitionList: util.ArrayList[Row]): Unit = {
    ...
    spark.sql("create table if not exists qara_mid.mid_qara_320020_p25hz_fillup (`file_no` VARCHAR(2147483647), `flt_dt` VARCHAR(2147483647), `tail_num` VARCHAR(2147483647), `time` INT, `time_series` INT, `acms_fp` INT, `acv_b_on2` INT, `ac_iden` INT, `ac_tail123` VARCHAR(2147483647), `ac_tail4` VARCHAR(2147483647), `ac_tail456` VARCHAR(2147483647), `ac_tail7` VARCHAR(2147483647), `ac_typ` INT, `ail_lh_avl_b` INT, `ail_lh_avl_g` INT, `ail_rh_avl_b` INT, `ail_rh_avl_g` INT, `airline_id` VARCHAR(2147483647), `airl_idt` VARCHAR(2147483647), `air_ground` FLOAT, `aiw_rw` INT, `alt_cpt` FLOAT, `alt_fo` FLOAT, `alt_swc` INT, `apr_ctl` INT, `apubld_vv_op` INT, `aspd_ctl` INT, `aud_tr_fail` INT, `bld_vlv1` INT, `bld_vlv2` INT, `bp1` FLOAT, `bp2` FLOAT, `cent_curr` INT, `city_from` VARCHAR(2147483647), `city_from_r` VARCHAR(2147483647), `city_to_r` VARCHAR(2147483647), `ck_conf_scl_mx` FLOAT, `ck_egt_scl_max` FLOAT, `ck_epr_scl_max` FLOAT, `ck_ins_eng_mod` INT, `ck_itt_scl_max` FLOAT, `ck_ldg_nr` INT, `ck_n1_scl_max` FLOAT, `ck_tla_scl_max` FLOAT, `ck_tla_scl_min` FLOAT, `ck_torq_scl_mx` FLOAT, `cmc_tr_fail` INT, `dat_day` FLOAT, `dat_month` FLOAT, `day_curr` INT, `db_upd_cyc` INT, `db_upd_date` INT, `dc1_bus_on` INT, `dc2_bus_on` INT, `dec_height` FLOAT, `dfc` INT, `dits_fail` INT, `dmc_1_invald` INT, `dmc_2_invald` INT, `dmc_3_invald` INT, `dmc_3_xfr_ca` INT, `dmc_3_xfr_fo` INT, `dmc_mark_id` INT, `dme_dis1` FLOAT, `dme_dis2` FLOAT, `dme_frq1` FLOAT, `dme_frq2` FLOAT, `drift` FLOAT, `ecamdu_1_off` INT, `ecamdu_2_off` INT, `ecamnd_xfrca` INT, `ecamnd_xfrfo` INT, `ecam_sel_mat` INT, `ecu_eec_1_cb` INT, `ecu_eec_2_cb` INT, `egp1` FLOAT, `egp2` FLOAT, `elac1_pt_flt` INT, `elac1_ro_flt` INT, `elac2_pt_flt` INT, `elac2_rl_flt` INT, `elac_1_fault` INT, `elac_2_fault` INT, `eng1_pt25` FLOAT, `eng2_pt25` FLOAT, `epr_max` FLOAT, `ext_tmp_eng1` FLOAT, `ext_tmp_eng2` FLOAT, `fdiu_fail` INT, `fdiu_prg_id` INT, `fdr_fail` INT, `fdr_pb_fail` INT, `flap_faul` INT, `flap_lever_c` FLOAT, `flare` FLOAT, `fleet_idt` INT, `flight_phas0` INT, `fltnum` FLOAT, `fwc_valid` INT, `gw` FLOAT, `head_selon` INT, `hpv_nfc_1` INT, `hpv_nfc_2` INT, `ident_eng1` FLOAT, `ident_eng2` FLOAT, `ils_frq1` FLOAT, `ils_frq2` FLOAT, `isov1` INT, `isov2` INT, `ivv_c` FLOAT, `landing_roll` FLOAT, `latp` FLOAT, `lat_ck_fail` INT, `lat_ck_n_r` INT, `ldg_seldw` INT, `ldg_selup` INT, `ldg_sel_up` FLOAT, `long_ck_fail` INT, `long_ck_n_r` INT, `lonp` FLOAT, `mach_selon` INT, `mls_select` INT, `mode_mmr1` INT, `mode_mmr2` INT, `mode_nd_capt` INT, `mode_nd_fo` INT, `month_curr` INT, `n1_epr_tgt1` INT, `nd_ca_an_off` INT, `nd_fo_an_off` INT, `nm_range_ca` INT, `nm_range_fo` INT, `norm_ck_fail` INT, `norm_ck_n_r` INT, `no_data_eec1` INT, `no_data_eec2` INT, `oil_prs1` FLOAT, `oil_prs2` FLOAT, `oil_tmp1` FLOAT, `oil_tmp2` FLOAT, `oiq1` FLOAT, `oiq2` FLOAT, `opv_nfo_1` INT, `opv_nfo_2` INT, `pfdnd_xfr_ca` INT, `pfdnd_xfr_fo` INT, `pfd_ca_anoff` INT, `pfd_fo_anoff` INT, `pitch_altr1` INT, `pitch_altr2` INT, `pitch_dir_lw` INT, `pitch_nor` INT, `playbk_fail` INT, `playbk_inact` INT, `prv_nfc_1` INT, `prv_nfc_2` INT, `qar_fail` INT, `qar_tapelow` INT, `sdac1_valid` INT, `sdac2_valid` INT, `sec_1_fault` INT, `sec_2_fault` INT, `sec_3_fault` INT, `slat_faul` INT, `spd_brk` INT, `stab_bld_pos1` FLOAT, `stab_bld_pos2` FLOAT, `start_vlv1` INT, `start_vlv2` INT, `sta_van_eng1` FLOAT, `sta_van_eng2` FLOAT, `tcas_sens_1` INT, `tcas_sens_2` INT, `tcas_sens_3` INT, `tla1_c` FLOAT, `tla2_c` FLOAT, `touch_and_go` FLOAT, `trb1_cool` FLOAT, `trb2_cool` FLOAT, `tt25_l` FLOAT, `tt25_r` FLOAT, `t_inl_prs1` FLOAT, `t_inl_prs2` FLOAT, `t_inl_tmp1` FLOAT, `t_inl_tmp2` FLOAT, `utc_hour` FLOAT, `utc_min_sec` INT, `vor_frq1` FLOAT, `vor_frq2` FLOAT, `win_spdr` FLOAT, `year_curr` INT, `year_med` FLOAT) PARTITIONED BY (`flt_dt`, `tail_num`, `file_no`) with('path'='hdfs://10.64.219.26:9000/flink/warehouse/qara_mid/mid_qara_320020_p25hz_fillup','connector' = 'lakesoul','last_schema_change_time' = '1730889294584');")
  ...
  private def deal2hzTableData(spark: SparkSession, partitionList: util.ArrayList[Row]): Unit = {
    ...
    spark.sql("create table if not exists qara_mid.mid_qara_320020_2hz_fillup (`file_no` VARCHAR(2147483647), `flt_dt` VARCHAR(2147483647), `tail_num` VARCHAR(2147483647), `time` INT, `time_series` INT,`ck_pitch_cpt` FLOAT, `ck_pitch_fo` FLOAT, `ck_roll_cpt` FLOAT, `ck_roll_fo` FLOAT, `ck_rudd` FLOAT,`pitch_cpt` FLOAT, `pitch_fo` FLOAT, `roll` FLOAT, `roll_abs` FLOAT, `roll_csn` FLOAT,`roll_max_ab500` FLOAT, `roll_max_bl100` FLOAT, `roll_max_bl20` FLOAT, `roll_max_bl500` FLOAT,`rudd` FLOAT, `spoil_gnd_arm` INT, `spoil_lout1` INT, `spoil_rout1` INT,`yaw_faul1` INT, `yaw_faul2` INT) PARTITIONED BY (`flt_dt`, `tail_num`, `file_no`) with('path'='hdfs://10.64.219.26:9000/flink/warehouse/qara_mid/mid_qara_320020_2hz_fillup','connector' = 'lakesoul','last_schema_change_time' = '1730889295406');")
    partitionList.forEach(partition => {
  ...
  private def deal4hzTableData(spark: SparkSession, partitionList: util.ArrayList[Row]): Unit = {
    ...
    spark.sql("create table if not exists qara_mid.mid_qara_320020_4hz_fillup (`file_no` VARCHAR(2147483647), `flt_dt` VARCHAR(2147483647), `tail_num` VARCHAR(2147483647), `time` INT, `time_series` INT,`latg` FLOAT, `latg_csn` FLOAT, `lift_off_pitch1` FLOAT, `lift_off_pitch2` FLOAT, `lift_off_pitch3` FLOAT, `lift_off_pitch4` FLOAT,`lift_off_raltc1` FLOAT, `lift_off_raltc2` FLOAT, `lift_off_raltc3` FLOAT, `lift_off_raltc4` FLOAT,`lift_off_t1` INT, `lift_off_t2` INT, `lift_off_t3` INT, `lift_off_t4` INT,`long` FLOAT, `longc` FLOAT, `long_csn` FLOAT,`pitch` FLOAT, `pitch_csn` FLOAT, `pitch_max_ld` FLOAT, `pitch_max_to` FLOAT,`pitch_ratavgto` FLOAT, `pitch_rate` FLOAT, `pitch_rate_csn` FLOAT, `pitch_ratmaxto` FLOAT) PARTITIONED BY (`flt_dt`, `tail_num`, `file_no`) with('path'='hdfs://10.64.219.26:9000/flink/warehouse/qara_mid/mid_qara_320020_4hz_fillup','connector' = 'lakesoul','last_schema_change_time' = '1730889295691');")
    partitionList.forEach(partition => {
      val fltDt = partition.get(0)
      val tailNum = partition.get(1)
      val fileNo = partition.get(2)
  ...
  private def deal8hzTableData(spark: SparkSession, partitionList: util.ArrayList[Row]): Unit = {
    ...
    spark.sql("create table if not exists qara_mid.mid_qara_320020_8hz_fillup (`file_no` VARCHAR(2147483647), `flt_dt` VARCHAR(2147483647), `tail_num` VARCHAR(2147483647), `time` INT, `time_series` INT,`bad_sf` INT, `lift_off` INT, `pad` INT, `t` INT, `time_stamp` INT, `time_tag` INT, `touch_down` INT, `turbulence` INT,`value_st` INT, `vrtg` FLOAT, `vrtg_avg` FLOAT, `vrtg_csn` FLOAT, `vrtg_max_air` FLOAT, `vrtg_max_gnd` FLOAT, `vrtg_max_ld` FLOAT) PARTITIONED BY (`flt_dt`, `tail_num`, `file_no`) with('path'='hdfs://10.64.219.26:9000/flink/warehouse/qara_mid/mid_qara_320020_8hz_fillup');")
    partitionList.forEach(partition => {
      System.out.println("begin deal with tuple: " + partition.toString());
      val fltDt = partition.get(0)
      val tailNum = partition.get(1)
